    ...
    {
        {
            "autumn", "Осенний сезон", "PLAYER_HEAD", autumn1,
            {
                ...
                }, // Mission
                {
                    {},
                    "FarmingMissions", defaultOptions, {},
                    {{{"sweet_berry_bush", "Брусники", 1200, "Выращено брусники"},
                    {"beetroots", "Свеклы", 450, "Выращено свеклы"},
                    {"sugar_cane", "Тростника", 400, "Выращено тростника"}}, {}, {}},
                    {6500, {},
                    {},
                    }
                }, // Mission
                ...
                }, // Mission
                {
                    ...
                    {{{"sweet_berry_bush", "Брусники", 2000, "Выращено брусники"},
                    {"beetroots", "Свеклы", 600, "Выращено свеклы"},
                    {"sugar_cane", "Тростника", 1000, "Выращено тростника"}}, {}, {}},
                    {1800, {},
                    {},
                    }
                }, // Mission
